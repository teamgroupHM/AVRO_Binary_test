...
class Employee
{
	...
	static File file1 = new File("/home/cloudera/workspace/AVRO_Test/src/Employee.avsc");
	static File file2 = new File("/home/cloudera/workspace/AVRO_Test/src/Employee2.avsc");
	
	static {
		try {
			SCHEMA = Schema.parse(file1); // parse(Employee.class.getResourceAsStream("/home/cloudera/workspace/AVRO_Test/src/Employee.avsc"));
			SCHEMA2 = Schema.parse(file2);			//parse(Employee.class.getResourceAsStream("/home/cloudera/workspace/AVRO_Test/src/Employee2.avsc"));
		}
		catch (IOException e)
		{
	...
	public static void testWrite(File file, Employee[] people) throws IOException {
		   ...
		   writer.create(Employee.SCHEMA, file);  //This puts the schema in the data file at the top
